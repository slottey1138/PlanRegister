...
<html>
  ...
  <div class="container col-md-12">
    <legend>ผลการเรียนนักศึกษา</legend>
    <div class="container col-md-12">
      ...
      <div class="col-md-8">
        ...
        ?>
      <div class="col-md-3">
      <a href="course-fail.php" class="btn btn-primary">รายวิชาที่ไม่ผ่าน</a>
        <a href="checkgrade.php" class="btn btn-primary">บันทึกผลการเรียน</a><br><br>
      </div>
      <div class="col-md-1">

      </div>
      <div class="container col-md-12">
        <div class="container col-md-12"></div><br>
